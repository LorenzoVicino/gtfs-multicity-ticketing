...
\copy gtfs_calendar_dates_raw FROM '/work/data/gtfs/incoming/BOLOGNA_norm/calendar_dates.txt' WITH (FORMAT csv, HEADER true)
\copy gtfs_trips_raw FROM '/work/data/gtfs/incoming/BOLOGNA_norm/trips.txt' WITH (FORMAT csv, HEADER true)
\copy gtfs_shapes_raw FROM '/work/data/gtfs/incoming/BOLOGNA_norm/shapes.txt' WITH (FORMAT csv, HEADER true)
