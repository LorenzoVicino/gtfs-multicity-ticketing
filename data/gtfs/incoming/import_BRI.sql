...
\copy gtfs_agency_raw FROM '/work/data/gtfs/incoming/BARI_norm/agency.txt' WITH (FORMAT csv, HEADER true)
\copy gtfs_routes_raw FROM '/work/data/gtfs/incoming/BARI_norm/routes.txt' WITH (FORMAT csv, HEADER true)
\copy gtfs_stops_raw FROM '/work/data/gtfs/incoming/BARI_norm/stops.txt' WITH (FORMAT csv, HEADER true)
...
VALUES ('BRI', 'Bari', 'N/A', 'IT', 'Europe/Rome')
...
SELECT
    ...
    COALESCE(NULLIF(a.agency_name, ''), 'Bari' || ' Transit'),
    NULLIF(a.agency_url, ''),
...
JOIN trip t
 ...
 AND t.service_date = '2026-02-21'::DATE
JOIN stop s
