...
\copy gtfs_agency_raw FROM :'agency_file' WITH (FORMAT csv, HEADER true)
...
\copy gtfs_shapes_raw FROM :'shapes_file' WITH (FORMAT csv, HEADER true)
...
VALUES (:'city_code', :'city_name', 'N/A', 'IT', 'Europe/Rome')
...
SELECT
    ...
    COALESCE(NULLIF(a.agency_name, ''), :'city_name' || ' Transit'),
    NULLIF(a.agency_url, ''),
